	    ...
	    */
	    ...
	    value: function render() {
	      ...
	      return (0, _h2.default)('div.playlist-time-scale', {
	        ...
	        attributes: {
				style: 'position: relative; left: 0; right: 0; margin-left: ' + this.marginLeft + 'px; opacity:0.5;'
	        }
	    ...
	    value: function render(data) {
	      ...
	      var grid = (0, _h2.default)('canvas.grid', {
	        attributes: {
	          width: width,
	          height: data.height,
	          style: 'position:absolute;pointer-events:none;opacity:0.3;'
	        },
	...
	var _class = function () {
	    ...
	    _createClass(_class, [{
	        ...
	        value: function draw(g, canvas) {
	            ...
	            g.strokeStyle = canvas.getAttribute('data-ringbgcolor') || '#464646;';
	            ...
	            g.strokeStyle = canvas.getAttribute('data-ringcolor') || '#90adb1';
	    ...
	    */
	    ...
	    value: function renderWaveform(data) {
	      ...
	      return (0, _h2.default)('div.clipwaveform', {
	        attributes: {
				style: 'background: #447587;height: ' + data.height + 'px;pointer-events: none;'
